...
void init(GLFWwindow* window)
{
	...
	wardrobeTexture::albedo = Core::LoadTexture("textures/door/albedo.png");
	wardrobeTexture::normal = Core::LoadTexture("textures/door/normal.png");
	wardrobeTexture::ambientOcclusion = Core::LoadTexture("textures/door/ambientOcclusion.png");
	wardrobeTexture::roughness = Core::LoadTexture("textures/door/roughness.png");
	wardrobeTexture::metalness = Core::LoadTexture("textures/door/metalness.png");
